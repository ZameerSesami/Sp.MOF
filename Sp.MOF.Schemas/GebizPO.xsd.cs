        ...
        <xs:element name=""HEADER"">
          <xs:complexType>
            <xs:sequence>
              ...
              <xs:element name=""DEPARTMENT_CODE"" type=""xs:string"" />
              <xs:element name=""ORDER_CODE"" type=""xs:string"" />
              <xs:element name=""EXTERNAL_SYSTEM_CODE"" type=""xs:string"" />
              <xs:element name=""AMENDMENT_NUMBER"" type=""xs:string"" />
              ...
              <xs:element name=""CREATE_TIMESTAMP"" type=""xs:string"" />
              <xs:element name=""TERMINATE_REASON"" nillable=""true"" type=""xs:anyType"" />
              <xs:element name=""TERMINATE_TIMESTAMP"" type=""xs:string"" />
              ...
              <xs:element name=""SUPPLIER"">
                <xs:complexType>
                  <xs:sequence>
                    ...
                    <xs:element name=""CONTACT_FAX"" type=""xs:string"" />
              ...
              <xs:element name=""FUND_COMMIT_AMOUNT"">
                <xs:complexType>
                  <xs:sequence>
                    ...
                    <xs:element name=""CURRENCY_AMOUNT"" type=""xs:string"" />
                  </xs:sequence>
                </xs:complexType>
              </xs:element>
              <xs:element name=""BUYER"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element name=""ORGANISATION_CODE"" type=""xs:string"" />
                    <xs:element name=""ORGANISATION_NAME"" type=""xs:string"" />
                    <xs:element name=""NAME"" type=""xs:string"" />
                    <xs:element name=""PHONE"" type=""xs:string"" />
                    <xs:element name=""FAX"" type=""xs:string"" />
                ...
                <xs:complexType>
                  <xs:sequence>
                    ...
                    <xs:element name=""SERVICE_ORDER"">
                      <xs:complexType>
                        <xs:sequence>
                          <xs:element name=""ORIG_UNIT_PRICE"" type=""xs:string"" />
                          <xs:element name=""ORIG_UNIT_OF_MEASURE"" type=""xs:string"" />
                          <xs:element name=""ORIG_QUANTITY"" type=""xs:string"" />
                        </xs:sequence>
                      </xs:complexType>
                    </xs:element>
                    <xs:element name=""UNIT_PRICE"" type=""xs:string"" />
                    <xs:element name=""PRICE_UNIT"" type=""xs:string"" />
                    ...
                    <xs:element name=""PART_NUMBER_INFORMATION"">
                      <xs:complexType>
                        <xs:sequence>
                          ...
                          <xs:element name=""MINIMUM_SHELF_LIFE"" type=""xs:string"" />
